...
import { 
    FETCH_CATEGORY_BEGIN, FETCH_CATEGORY_SUCCESS, FETCH_CATEGORY_ERROR, 
    FETCH_MEALS_BEGIN, FETCH_MEALS_SUCCESS, FETCH_MEALS_ERROR,
    FETCH_SINGLE_MEAL_BEGIN, FETCH_SINGLE_MEAL_SUCCESS, FETCH_SINGLE_MEAL_ERROR,
